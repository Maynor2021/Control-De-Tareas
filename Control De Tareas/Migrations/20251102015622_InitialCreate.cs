        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nombre = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tareas_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Tareas_Courses_CoursesId",
                        column: x => x.CoursesId,
                        principalTable: "Courses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tareas_Users_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Submissions_Tareas_TareaId",
                        column: x => x.TareaId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Submissions_TareaId",
                table: "Submissions",
                column: "TareaId");

            migrationBuilder.CreateIndex(
                name: "IX_Tareas_CourseId",
                table: "Tareas",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_Tareas_CoursesId",
                table: "Tareas",
                column: "CoursesId");

            migrationBuilder.CreateIndex(
                name: "IX_Tareas_CreatedBy",
                table: "Tareas",
                column: "CreatedBy");

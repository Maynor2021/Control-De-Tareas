...
-- Módulo de Cerrar Sesión (AccountController - IMPORTANTE para todos)
(NEWID(), 'Cerrar Sesión', 'Account', 'Logout', GETDATE(), GETDATE(), @AdminUserId, @AdminUserId, 0, @MGUsuariosId);

PRINT '- Módulos REALES insertados: 12 (solo los que existen en vistas/controladores)';
...
WHERE 
    ...
    OR
    -- PROFESOR: Dashboard, Cursos, Tareas (crear/editar/eliminar), Cerrar Sesión
    ...
    OR
    -- ESTUDIANTE: SOLO Dashboard, Tareas y Cerrar Sesión (sin módulos de autenticación en el dashboard)
